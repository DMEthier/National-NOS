...
qq <- filter(canada, name %in% c("Alberta"))
...
source("ii-datamanip.R") #Total Observation Count

source("ii-datamanip2.R") #Silent Listening Period ONLY
...
## Combine Provinical Outputs and Plot 

...
write.table(Events, file = paste(out.dir,  "QC_Events",".csv", sep = ""), row.names = FALSE, append = FALSE, quote = FALSE, sep = ",")
...
#If you are just interested in the silent listening period. 

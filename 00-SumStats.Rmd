...
data<-data %>% filter(!is.na(CommonName))
data<-data %>% mutate(ObservationCount = ifelse(is.na(ObservationCount), 1, ObservationCount))
...
data<-data %>% filter(is.na(EffortMeasurement14)|EffortMeasurement14==0)
